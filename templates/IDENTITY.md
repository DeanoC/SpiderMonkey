...
This is a template for your public persona. Replace these items by writing updates through your worker-owned memory namespace, typically `/nodes/<worker-id>/venoms/memory/control/*`.
